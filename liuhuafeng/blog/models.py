...
class Part(models.Model):
    Epart = models.CharField(max_length=30,blank=True,verbose_name=u'英文分类')
    Cpart = models.CharField(max_length=30,blank=True,verbose_name=u'中文分类')
...
class Tag(models.Model):
    Etag = models.CharField(max_length=30,blank=True,verbose_name=u'英文标签')
    Ctag = models.CharField(max_length=30,blank=True,verbose_name=u'中文标签')
